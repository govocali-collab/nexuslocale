    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <button onClick={launch} disabled={!ready || pending}
          className="rounded-md bg-[#5701f3] hover:bg-[#4801cc] disabled:opacity-80 disabled:cursor-not-allowed
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <button onClick={launch} disabled={pending}
          className="rounded-md bg-[#5701f3] hover:bg-[#4801cc] disabled:opacity-80 disabled:cursor-not-allowed px-4 py-2 text-sm text-white transition-colors">
  ...
  return (
    <div className="space-y-4">
      ...
      <button onClick={launch} disabled={pending || !siteId}
        className="rounded-md bg-[#5701f3] hover:bg-[#4801cc] disabled:opacity-80 px-5 py-2
...
function CronPanel() {
  ...
  return (
    <div className="space-y-4">
      ...
      <button onClick={launch} disabled={pending}
        className={`rounded-md px-5 py-2 text-sm font-medium text-white transition-colors disabled:opacity-80
